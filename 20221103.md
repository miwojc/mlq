...
To get straight to the answer, every one of the choices is a correct answer: decision trees are really powerful!
...
* Scikit-Learn's ["Multiclass and multioutput algorithms"](https://scikit-learn.org/stable/modules/multiclass.html#multilabel-classification) will introduce you to solve these problems using Scikit-Learn's decision tree implementation.
* ["How can Regression Trees be used for Solving Regression Problems?"](https://medium.com/analytics-vidhya/regression-trees-decision-tree-for-regression-machine-learning-e4d7525d8047) is an excellent article about using decision trees for regression tasks.
:::
